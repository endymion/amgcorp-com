...
describe ProfilesController do
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created profile as @profile" do
        Profile.stub(:new).with({'these' => 'params'}) { mock_profile(:save => true) }
        post :create, :profile => {'these' => 'params'}
        assigns(:profile).should be(mock_profile)
      end

      it "redirects to the created profile" do
        Profile.stub(:new) { mock_profile(:save => true) }
        post :create, :profile => {}
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved profile as @profile" do
        Profile.stub(:new).with({'these' => 'params'}) { mock_profile(:save => false) }
        post :create, :profile => {'these' => 'params'}
        assigns(:profile).should be(mock_profile)
      end
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested profile" do
        Profile.should_receive(:find).with("37") { mock_profile }
        mock_profile.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => "37", :profile => {'these' => 'params'}
      end

      it "assigns the requested profile as @profile" do
        Profile.stub(:find) { mock_profile(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:profile).should be(mock_profile)
      end
    ...
    describe "with invalid params" do
      it "assigns the profile as @profile" do
        Profile.stub(:find) { mock_profile(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:profile).should be(mock_profile)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the profiles list" do
      Profile.stub(:find) { mock_profile }
      delete :destroy, :id => "1"
